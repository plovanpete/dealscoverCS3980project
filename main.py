...
from BackEnd.secretmenu.routes.recipes import recipes_router
from BackEnd.restaurants.model.RestaurantModel import RestaurantRequest
from BackEnd.secretmenu.model.RecipeModel import RecipeRequest
...
app.mount("/secretmenu", StaticFiles(directory="FrontEnd/secretmenu"), name="secretmenu")
...
def create_recipe(recipe: RecipeRequest):
    # Access the recipe data sent from the client
    name = recipe.name
...
async def view_secrets():
    return FileResponse("./FrontEnd/secretmenu/views/index.html")
